...
public class CheckProgress_MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_progress_maps);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(CheckProgress_MapsActivity.this, "Check Progress Map", Toast.LENGTH_SHORT).show();
            }
        });
    }
